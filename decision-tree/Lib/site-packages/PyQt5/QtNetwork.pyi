...
class QLocalSocket(QtCore.QIODevice):
    ...
    def writeData(self, a0: PyQt5.sip.array[bytes]) -> int: ...
    def readData(self, maxlen: int) -> bytes: ...
    stateChanged: typing.ClassVar[QtCore.pyqtSignal]
    errorOccurred: typing.ClassVar[QtCore.pyqtSignal]
    disconnected: typing.ClassVar[QtCore.pyqtSignal]
...
class QUdpSocket(QAbstractSocket):
    ...
    @typing.overload
    def writeDatagram(self, data: PyQt5.sip.array[bytes], host: typing.Union[QHostAddress, QHostAddress.SpecialAddress], port: int) -> int: ...
    @typing.overload
